    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-sm">
                  {campaign.title === "Elektrikli Scooter Paylaşım Ağı"
                    ? campaign.companyName
                    : campaign.title}
                </span>
              </div>
              <div className="text-[#4DB05F] font-bold text-sm mb-2">
                ₺ {campaign.amount.toLocaleString()}
              </div>
              <Button
                size="sm"
                className="w-full bg-kfs hover:bg-kfshover/90 text-white text-xs"
              >
                {t("viewDetails")}
              </Button>
            </div>
        ...
        <div className="flex justify-center mt-8">
          <Button
            variant="outline"
            className="bg-kfs text-white hover:bg-kfshover/90 hover:text-white"
          >
            {t("viewMore")}
          </Button>
        </div>
