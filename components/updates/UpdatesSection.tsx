...
const mockUpdates: Update[] = [
  ...
  },
  {
    id: "5",
    date: "13.01.2025",
    content: "Girişim şirketimizin güncel gelişmelerini içeren bilgilendirme dokümanı ektedir.",
    hasAttachment: true,
    attachmentUrl: "#",
  },
  {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm text-gray-500">Toplam: {mockUpdates.length} güncelleme</div>
      </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="relative z-10 flex items-center justify-center w-[70px] h-[26px] bg-white">
                  <div
                    ...
                    ${hoveredCard === update.id ? "bg-[#4DB05F] scale-125" : "bg-gray-300"}
                  `}
                  />
                </div>
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1">
                        <p className="text-sm font-medium text-gray-500">{formatDate(update.date)}</p>
                        <p className="text-gray-700 leading-relaxed">{update.content}</p>
                        {update.hasAttachment && (
                          <Button
                            variant="ghost"
                            size="sm"
                            className="mt-2 text-[#4DB05F] hover:text-[#4DB05F] hover:bg-[#4DB05F]/10"
                          >
                      ...
                      <div className="flex-shrink-0">
                        <div
                          ...
                          ${hoveredCard === update.id ? "bg-[#4DB05F]/10" : "bg-gray-100"}
                        ...
                        >
                          <CheckCircle2
                            className={`
                            w-5 h-5
                            ${hoveredCard === update.id ? "text-[#4DB05F]" : "text-gray-400"}
                            transition-colors duration-300
                          `}
                          />
                        </div>
