...
const mockFAQs: FAQ[] = [
  ...
  },
  {
    id: "2",
    question:
      "Merhaba kar kolay gelsin fonlama 25.000.000 tl den 10.000.000 tl yemi düştü duyurulardan okudumdai",
    answer:
    ...
    <div className="space-y-6">
      ...
      <Alert className="bg-yellow-50 border-yellow-100">
        ...
        <AlertDescription className="text-yellow-800">
          Değerli yatırımcımız, bu bölümde sadece yatırım turuna çıkan girişime
          yönelik sorular cevaplanmaktadır. Lütfen platform ya da kitle fonlama
          sistemi ile ilgili sorularınızı{" "}
          <a
            href="mailto:info@fenbahceu.com"
            className="text-[#4DB05F] hover:underline"
          >
            info@fenbahceu.com
          </a>{" "}
          adresine iletiniz. Girişim ya da girişim şirketi ile ilgili olmayan
          sorularınız onaylanmayacaktır.
        </AlertDescription>
      </Alert>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Button type="submit" className="bg-kfs hover:bg-kfshover/90">
