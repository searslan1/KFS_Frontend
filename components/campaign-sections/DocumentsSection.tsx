  ...
  const DocumentUploadArea = ({
    ...
    <div
      className={cn(
        ...
        dragOver === section ? "border-[#4DB05F] bg-[#4DB05F]/5" : "border-gray-200",
      )}
  ...
  return (
    <div className="space-y-8">
      <Alert>
        ...
        <AlertDescription>
          Yüklediğiniz tüm belgeler platform yöneticileri tarafından incelenecek ve onaylanacaktır.
        </AlertDescription>
      </Alert>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <Label className="text-lg font-semibold">Patent, Marka Tescil ve Belge Bilgileri</Label>
              <p className="text-sm text-gray-500">Patent, marka tescil ve diğer resmi belgelerinizi yükleyin</p>
            </div>
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                ...
                <div className="flex-grow space-y-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{new Date(doc.date!).toLocaleDateString("tr-TR")}</p>
                    </div>
                    <Button variant="ghost" size="icon" onClick={() => removeDocument(doc.id, "patents")}>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setPatents((prev) =>
                        prev.map((d) => (d.id === doc.id ? { ...d, description: e.target.value } : d)),
                      )
                    }
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">Aldığınız ödül ve başarı belgelerini yükleyin</p>
            </div>
          </div>
              ...
              >
                ...
                <div className="flex-grow space-y-2">
                  <div className="flex items-start justify-between">
                    ...
                    <Button variant="ghost" size="icon" onClick={() => removeDocument(doc.id, "awards")}>
                      <Trash2 className="h-4 w-4 text-red-500" />
                    </Button>
                  </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">Gerekli izin ve onay belgelerini yükleyin</p>
            </div>
          </div>
              ...
              >
                ...
                <div className="flex-grow space-y-2">
                  <div className="flex items-start justify-between">
                    ...
                    <Button variant="ghost" size="icon" onClick={() => removeDocument(doc.id, "permits")}>
                      <Trash2 className="h-4 w-4 text-red-500" />
                    </Button>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
